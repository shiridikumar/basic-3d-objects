...
int main(){
	...
	myMatrix = glm::translate(myMatrix,  glm::vec3(40.0f, 40.0f, 0.0f));
	...
	// transMatrix = glm::translate(transMatrix, glm::vec3(10.0f, 0.0f, 0.0f));
	// const float *pSource1=(const float *)glm::value_ptr(transMatrix);
	// cout<<endl;
	// glm::vec4 myVector(10.0f, 10.0f, 10.0f, 0.0f);
	// glm::vec4 transformedVector = transMatrix * myVector;
	// const float *pSource2=(const float *)glm::value_ptr(transformedVector);
	// int ind=0;
	// for(int i=0;i<16;i++){
	// 	cout<<pSource2[i]<<"---";
	// }
	...
	// 	float x=vertices[i],y=vertices[i+1],z=vertices[i+2],w=vertices[i+3];
	// 	glm::vec4 oldvec(10.0f,10.0f,10.0f,0.0f);
